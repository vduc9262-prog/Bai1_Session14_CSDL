...
-- sự cố tiền đã trừ nhưng nợ không giảm vi phạm đặc tính atomicity 
-- vì giao dịch không được thực hiện trọn vẹn mà dừng giữa chừng

-- xóa thủ tục đã từng tồn tại 
